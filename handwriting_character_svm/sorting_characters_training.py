...
class Extract_Letters:
    def extractFile(self, filename, thresh):
        ...
        bw = image < thresh #image less than threshold
        ...
        for i in range(len(lines)):
            for j in range(len(lines[i])):
                ...
                if tl_2 > prev_tr and bl_2 > prev_line_br:
                    ...
                    letter_norm = imresize(letter_raw.astype(np.float32) ,(15 ,15))
...
#my handwriting
training_files = ['./ocr/training/training1.png', './ocr/training/training2.png','./ocr/training/training3.png','./ocr/training/training4.png','./ocr/training/my_adobe.png']
...
letters = extract.extractFile(training_files[4], 180)
string_counter = 0
