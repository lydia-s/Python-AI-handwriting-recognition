...
training_files = ['./ocr/testing/testing1.png', './ocr/testing/testing2.png']



name_counter = 600
sig1 = extract.extractFile(training_files[0], 160)
print len(sig1)
string_counter = 0
...
for i in sig1:
	if string_counter < 5:
		...
		imsave('./testing_type/' + 'Lydia' + '/' + str(name_counter) + '_snippet.png', i)
...
for i in sig2:
	if string_counter < 5:
		string_counter = 0
		imsave('./testing_type/' + 'Josh' + '/' + str(name_counter) + '_snippet.png', i)
		#print 'training character: ' + str(folder_string[string_counter]) + ' (' + str(name_counter) + '/' + str(len(letters)) + ')'
		string_counter += 1
		name_counter += 1
