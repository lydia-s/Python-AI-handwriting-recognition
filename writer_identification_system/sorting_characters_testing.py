...
testing_files = ['./ocr/testing/adobe.png','./ocr/testing/adobe1.png','./ocr/testing/adobe2.png','./ocr/testing/adobe3.png','./ocr/testing/shazam.png', './ocr/testing/shazam1.png']
...
#letters = extract.extractFile(testing_files[0], 180) #Lydia adobe
#string_counter = 0

#for i in letters:
#    if(folder_string1[string_counter] != '0' and folder_string1[string_counter] != '(' and folder_string1[string_counter] != ')'):
#	imsave('./testing_type/' + 'Lydia' + '/' + str(folder_string1[string_counter]) + '/' + str(name_counter) + '_snippet.png', i)
...
#letters = extract.extractFile(testing_files[1], 120) + extract.extractFile(testing_files[2], 120) + extract.extractFile(testing_files[3], 120) #Josh adobe
#string_counter = 0
...
#for i in letters:
#    if(folder_string1[string_counter] != '0' and folder_string1[string_counter] != '(' and folder_string1[string_counter] != ')'):
#	imsave('./testing_type/' + 'Josh' + '/' + str(folder_string1[string_counter]) + '/' + str(name_counter) + '_snippet.png', i)
		
#	name_counter += 1
        
#    string_counter += 1

letters = extract.extractFile(testing_files[4], 180) #Lydia shazam
string_counter = 0


for i in letters:
    if(folder_string2[string_counter] != '0' and folder_string2[string_counter] != '(' and folder_string2[string_counter] != ')'):
	imsave('./testing_type/' + 'Lydia' + '/' + str(folder_string2[string_counter]) + '/' + str(name_counter) + '_snippet.png', i)
...
letters = extract.extractFile(testing_files[5], 120) #Josh shazam
string_counter = 0

for i in letters:
    if(folder_string2[string_counter] != '0' and folder_string2[string_counter] != '(' and folder_string2[string_counter] != ')'):
	imsave('./testing_type/' + 'Josh' + '/' + str(folder_string2[string_counter]) + '/' + str(name_counter) + '_snippet.png', i)
